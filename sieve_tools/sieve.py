...
def erat_first(nmax = 55):
    """ Simple way to execute Eratosthenes prime number calculation until number nmax.
    """
    all_primes = []
...
def erat_efficient(nmax = 55):
    """More efficient way to execute Eratosthenes prime number calculation until number nmax.
    """
    all_primes = []
...
def get_primes(nmax = 55, method = 1):
    """Returns the prime numbers until number nmax, either using the simple method (1) or the efficient method (2).
    """
    if method == 1:
        return erat_first(nmax)
    else:
        return erat_efficient(nmax)
    
def proportion_primes(nmax = 55):
